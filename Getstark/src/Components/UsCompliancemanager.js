...
export default function UsCompliancemanager() {
  return (
   <>
    <div className="usheader">
                <div className="ushtext pmtext">
                    <h6 className="ush6-1">FOR COMPLIANCE MANAGERS</h6>
                    <h1 className="ush1-1 pmh1">Centralize your accessibility compliance</h1>
                    <p className="usp-1">Managing digital accessibility compliance requires the same level of rigor and prioritization as security and privacy. With Stark’s Compliance Center, managing your accessibility posture and growing your company’s accessibility maturity becomes centralized, actionable, automated.</p>

                    <button className="usbtn1">Sign up for free</button>
                    <button className="usbtn2">Start a free trial</button>
                </div>
                <div className="ushimg">
                    <img src={require('../assets/images/99.png')} alt="img loading" />
                </div>
            </div>
