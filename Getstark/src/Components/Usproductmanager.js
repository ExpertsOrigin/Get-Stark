...
import '../assets/style/Usproductmanager.css'
import Card from 'react-bootstrap/Card';

export default function Usproductmanager() {
  return (
   <>
   {/* header */}
...
<div className="ussection1">
                <div className="uss1img">
                    <img src={require('../assets/images/94.png')} alt="" />
                </div>
                <h1 className="uss1h1-1 pms2h1">Send issues directly to your ticketing system and track progress</h1>
                <p className="uss1p-1">Whether it's a design file, code repo or live site – Send accessibility issues directly from Stark’s real-time reports as tickets to your projects in Asana, Jira, Trello, Azure DevOps, Bitbucket, Github Issues, GitLab, Linear and more.</p>
            ...
            <div className="ussection1">
                <div className="uss1img">
                    <img src={require('../assets/images/95.png')} alt="" />
                </div>
                <h1 className="uss1h1-1 pms2h1">Manage your accessibility posture across the entire organization</h1>
                <p className="uss1p-1">Addressing the issue of digital accessibility requires the same level of rigor and prioritization as security and privacy. With Stark's compliance frameworks and controls, growing your company's accessibility maturity finally becomes actionable.</p>
                <button className="uss1btn1">Get started for free</button>
            </div>
            ...
            <div className="ussection1">
                <div className="uss1img">
                    <img src={require('../assets/images/76.png')} alt="" />
                </div>
                <h1 className="uss1h1-1">Find and fix accessibility issues in designs 10x faster with AI</h1>
                <p className="uss1p-1">57% of accessibility issues originate in the design phase. Sidekick in Stark automatically scans Figma or Sketch files and, within seconds, makes suggestions for how to fix the accessibility issues - no prior knowledge needed.</p>
                <button className="uss1btn1">Get started for free</button>
            </div>
            ...
            <div className="ussection1">
                ...
                <h1 className="uss1h1-1 pms2h1">Integrated, advanced tooling that saves you up to 100x the dev cost</h1>
                <p className="uss1p-1">Scan for accessibility issues as early as first lines of code. With continuous scanning in your repos as well as code highlighting in the browser, live preview to test fixes, and lightning fast WCAG audits, Stark’s integrated tools are web dev powerhouse.</p>
                <button className="uss1btn1">Get started for free</button>
            </div>
