...
import '../assets/style/Usdesigners.css'
import Card from 'react-bootstrap/Card';
import Navigation from './Navigation';

export default function Usdesigners() {
    return (
        <>
    
    
            <div className="usheader">
                <div className="ushtext">
                    <h6 className="ush6-1">FOR DESIGNERS</h6>
                    <h1 className="ush1-1">Accessible, by design</h1>
                    <p className="usp-1">Stark helps eliminate up to 100% of the accessibility issues originating in design. Our AI-powered Sidekick experience combined with our best-in-class manual tools helps every designer find and fix accessibility issues within seconds. And hand over fully annotated designs to developers.</p>

                    <button className="usbtn1">Sign up for free</button>
                    <button className="usbtn2">Start a free trial</button>
                </div>
                <div className="ushimg">
                    <img src={require('../assets/images/75.png')} alt="img loading" />
                </div>
            </div>
            ...
            <div className="ussection1">
                <div className="uss1img">
                    <img src={require('../assets/images/77.png')} alt="img loading" />
                </div>
                <h1 className="uss1h1-1">Smoothest design to developer hand-off in the business</h1>
